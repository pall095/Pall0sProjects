...
import pandas as pd
from Classes.ManagerConfig import FrameColumns
...
class ExpenseManager :
    ...
    @staticmethod
    def from_frames( frames : pd.DataFrame | list[ pd.DataFrame ] ) :
        ...
        if isinstance( frames , pd.DataFrame ) :
            ...
            raise TypeError( "frames must be either a data frame or a list of data frames")
    ...
    def get_metrics_string( self ) :
        ...
        s = s + "\n"
        for label , label_dict in self.get_per_label( ).items( ) :
